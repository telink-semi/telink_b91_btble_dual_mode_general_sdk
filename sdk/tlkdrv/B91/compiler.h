...
/*******************************      BT/BLE Use     ******************************/
#define STATISTICAL_MODE							0		//Used to count section size
#if (STATISTICAL_MODE)
#define _attribute_ble_retention_code_   		__attribute__((section(".ble_retention_code")))__attribute__((noinline))
#define _attribute_ble_ram_code_      			__attribute__((section(".ble_ram_code")))  __attribute__((noinline))
#define _attribute_ble_data_retention_   		__attribute__((section(".ble_retention_data")))

#define _attribute_bt_retention_code_   		__attribute__((section(".bt_retention_code")))__attribute__((noinline))
#define _attribute_bt_ram_code_      			__attribute__((section(".bt_ram_code")))  __attribute__((noinline))
#define _attribute_bt_data_retention_   		__attribute__((section(".bt_retention_data")))
#else
...
#ifndef _attribute_retention_code_access_
#define _attribute_retention_code_access_		_attribute_bt_retention_code_
#endif 
