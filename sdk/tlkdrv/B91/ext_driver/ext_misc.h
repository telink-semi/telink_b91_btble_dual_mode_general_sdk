...
#include "types.h"
#include "tlkdrv/B91/trng.h"
#include "tlkdrv/B91/analog.h"
#include "tlkdrv/B91/dma.h"
#include "tlkdrv/B91/gpio.h"
#include "tlkdrv/B91/pm.h"
#include "tlkdrv/B91/timer.h"
#include "tlkdrv/B91/flash.h"
#include "tlkdrv/B91/mdec.h"
#include "tlkdrv/B91/trng.h"
#include "tlkdrv/B91/sys.h"
#include "tlkdrv/B91/plic.h"
...
extern unsigned int aes_base_addr;
/******************************* aes_end ********************************************************************/
 ...
 * @return  none
 */
static inline void hw_timer_irq_enable(irq_source_e  timer_src)
{
 ...
 * @return  none
 */
static inline void hw_timer_irq_disable(irq_source_e  timer_src)
{
	reg_irq_src0 &= ~BIT(timer_src);
}
/******************************* timer_end ******************************************************************/
