 ...
 *                                              global variable                                                       *
 *********************************************************************************************************************/
_attribute_data_retention_ dma_config_t uart_tx_dma_config[2]={
...
_attribute_data_retention_ dma_config_t uart_rx_dma_config[2]={
 ...
 *                                              local variable                                                     *
 *********************************************************************************************************************/
 unsigned char uart_dma_tx_chn[2];
 unsigned char uart_dma_rx_chn[2];
 unsigned int uart_dma_rev_size[2];
/**********************************************************************************************************************
