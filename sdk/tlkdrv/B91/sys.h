...
#define convert_ram_addr_bus_to_cpu(addr)  convert_ram_addr_bus2cpu(addr)

#define CHIP_EAGLE_A0	0xff
#define CHIP_EAGLE_A2	0xfa
...
void reload_ram_code_section (void);
void reload_data_section (void);


_attribute_retention_code_ void reset_bss_section (void);
