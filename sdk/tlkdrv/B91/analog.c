 ...
 */
_attribute_retention_code_ unsigned char analog_read_reg8(unsigned char addr){
 ...
 * @return     none.
 */
_attribute_retention_code_ void analog_write_reg8(unsigned char addr, unsigned char data){
	unsigned int r= core_disable_interrupt();
	reg_ana_addr = addr;
    reg_ana_data(0) = data;
 ...
 * @return     none.
 */
_attribute_retention_code_ void analog_write_reg16(unsigned char addr, unsigned short data)
{
	unsigned int r = core_disable_interrupt();
	reg_ana_addr = addr;
 ...
 * @return     the result of read.
 */
_attribute_retention_code_ unsigned short analog_read_reg16(unsigned char addr)
{
	unsigned int r= core_disable_interrupt();
	reg_ana_len=2;
	reg_ana_addr = addr;
 ...
 * @return     the result of read.
 */
_attribute_retention_code_ unsigned int analog_read_reg32(unsigned char addr)
{
	unsigned int r = core_disable_interrupt();
	reg_ana_len = 4;
	reg_ana_addr = addr;
 ...
 * @return     none.
 */
_attribute_retention_code_ void analog_write_reg32(unsigned char addr, unsigned int data)
{
	unsigned int r = core_disable_interrupt();
	reg_ana_addr = addr;
