...
//------------------------------------ bt use -----------------------------------//
/**
 * @brief     	This function is used to set eagle swire clk as sws role.
 * @param[in] 	clk_div		- eagle configure swire clk divider as sws role.
 * @return	  	0:fail  1:success.
 */
unsigned char sws_set_clk_div(unsigned char clk_div,unsigned char slave_id);

unsigned char sws_set_id(unsigned char cur_slave_id,unsigned char new_slave_id);
/**
 * @brief     	This function is used to init swire func as swm role.
 * @param[in] 	clk		- configure swire clk as swm role.
 * @return	    none.
 */
void swm_init(unsigned int clk);
