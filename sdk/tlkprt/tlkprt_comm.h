...
typedef enum{
	...
	//TLKPRT_COMM_MTYPE_BT
	TLKPRT_COMM_CMDID_BT_CONNECT = 0x01, //ACL,SCO,SPP,HFP(HF/AG),MAP,PBAP,A2DP(TG/AG)
	...
	TLKPRT_COMM_CMDID_BT_GET_PDL, //PDL -- Peer Device List
	...
	TLKPRT_COMM_CMDID_LE_GET_ADDR = 0x12,
	...
	TLKPRT_COMM_CMDID_FILE_START,
	TLKPRT_COMM_CMDID_FILE_PAUSE,
	TLKPRT_COMM_CMDID_FILE_CLOSE,
...
typedef enum{
	...
	//TLKPRT_COMM_MTYPE_BT
	TLKPRT_COMM_EVTID_BT_CONNECT = 0x01, //ACL,SCO,SPP,HFP(HF/AG),MAP,PBAP,A2DP(TG/AG)
