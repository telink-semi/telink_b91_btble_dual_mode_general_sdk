...
#define TLKMDI_CFG_AUDSNK_ENABLE              (1 && TLK_MDI_AUDIO_ENABLE && TLK_STK_BT_ENABLE)
#define TLKMDI_CFG_AUDSCO_ENABLE              (1 && TLK_MDI_AUDIO_ENABLE && TLK_STK_BT_ENABLE)
#define TLKMDI_CFG_AUDHFP_ENABLE              (1 && TLK_MDI_AUDIO_ENABLE && TLK_STK_BT_ENABLE)
#define TLKMDI_CFG_AUDUAC_ENABLE              (1 && TLK_MDI_AUDIO_ENABLE && TLK_USB_UAC_ENABLE)
