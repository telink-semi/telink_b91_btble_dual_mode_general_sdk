 ...
 * Descr: 
*******************************************************************************/
#define TLKMDI_CFG_AUDPLAY_ENABLE             (1 && TLK_MDI_AUD_ENABLE && TLK_MDI_MP3_ENABLE)
#define TLKMDI_CFG_AUDTONE_ENABLE             (1 && TLK_MDI_AUD_ENABLE && TLK_MDI_MP3_ENABLE)
#define TLKMDI_CFG_AUDSRC_ENABLE              (1 && TLK_MDI_AUD_ENABLE && TLK_MDI_MP3_ENABLE)
#define TLKMDI_CFG_AUDSNK_ENABLE              (1 && TLK_MDI_AUD_ENABLE)
#define TLKMDI_CFG_AUDSCO_ENABLE              (1 && TLK_MDI_AUD_ENABLE)
#define TLKMDI_CFG_AUDHFP_ENABLE              (1 && TLK_MDI_AUD_ENABLE)
#define TLKMDI_CFG_VOL_GRAD_INC_ENABLE        (1 && TLK_MDI_AUD_ENABLE)       
#define TLKMDI_CFG_REUSE_SPKBUFF_ENABLE       (0 && TLK_MDI_AUD_ENABLE)

#define TLKMDI_CFG_MP3_NAME_SIZE              40
