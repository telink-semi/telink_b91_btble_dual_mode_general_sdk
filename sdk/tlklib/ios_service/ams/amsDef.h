...
}ams_sevice_state_t;///AMS在连接初始用于建立AMS服务时会用到的各种状态
...
typedef struct{
	...
	ams_sevice_state_t  	ams_system_state;
}ams_state_flag;
...
typedef struct{
	...
	ams_playerPlaybackInfo_t	playbackParm;
}ams_notifyEntity_parm;
