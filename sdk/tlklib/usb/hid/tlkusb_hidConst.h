...
const uint08 cTlkUsbHidKeyboardDesc[] = {
    TLKUSB_HID_RPT_USAGE_PAGE			(8, 0x01),
	TLKUSB_HID_RPT_USAGE				(8, 0x06),
	TLKUSB_HID_RPT_COLLECTION			(8, 0x01),
		TLKUSB_HID_RPT_USAGE_PAGE		(8, 0x07),
		TLKUSB_HID_RPT_USAGE_MINIMUM		(8, 0xE0),
		TLKUSB_HID_RPT_USAGE_MAXIMUM	(8, 0xE7),
		TLKUSB_HID_RPT_LOGICAL_MINIMUM	(8, 0x00),
		TLKUSB_HID_RPT_LOGICAL_MAXIMUM	(8, 0x01),
		TLKUSB_HID_RPT_REPORT_COUNT		(8, 0x08),
		...
		TLKUSB_HID_RPT_USAGE_PAGE		(8, 0x08),
		...
		TLKUSB_HID_RPT_REPORT_COUNT		(8, 0x06),
		TLKUSB_HID_RPT_REPORT_SIZE		(8, 0x08),
		TLKUSB_HID_RPT_LOGICAL_MINIMUM	(8, 0x00),
		0x26, 0xa4,	0x00,
		TLKUSB_HID_RPT_USAGE_PAGE		(8, 0x07),
		TLKUSB_HID_RPT_USAGE_MINIMUM	(8, 0x00),
		0x2a, 0xa4, 0x00,
