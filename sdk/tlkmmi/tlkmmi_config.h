...
#define TLKMMI_BTREC_ENABLE         (1 && TLKMMI_BTMGR_ENABLE && TLK_MDI_BTREC_ENABLE)
#define TLKMMI_BTINQ_ENABLE         (1 && TLKMMI_BTMGR_ENABLE && TLK_MDI_BTINQ_ENABLE)
#define TLKMMI_BTACL_ENABLE         (1 && TLKMMI_BTMGR_ENABLE && TLK_MDI_BTACL_ENABLE)
