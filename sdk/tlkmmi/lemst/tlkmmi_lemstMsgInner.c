...
/******************************************************************************
 * Function: tlkmmi_lemst_sendCommXxx.
 * Descript: send the lemst command or Response or Event.
 * Params:
 ...
 * Others: None.
*******************************************************************************/
int tlkmmi_lemst_sendCommCmd(uint08 cmdID, uint08 *pData, uint08 dataLen)
{
	uint08 head[4];
	uint08 headLen = 0;
...
int tlkmmi_lemst_sendCommRsp(uint08 cmdID, uint08 status, uint08 reason, uint08 *pData, uint08 dataLen)
{
	uint08 head[8];
	uint08 headLen = 0;
...
int tlkmmi_lemst_sendCommEvt(uint08 evtID, uint08 *pData, uint08 dataLen)
{
	uint08 head[4];
	uint08 headLen = 0;
...
int tlkmmi_lemst_innerMsgHandler(uint08 msgID, uint08 *pData, uint08 dataLen)
{
