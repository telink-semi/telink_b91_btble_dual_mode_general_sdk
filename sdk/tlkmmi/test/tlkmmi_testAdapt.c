 ...
 * Others: None.
*******************************************************************************/
int tlkmmi_test_adaptInit(void)
{
	return tlktsk_adapt_init(TLKMMI_TEST_PROCID);
}
...
{
	tlktsk_adapt_handler(TLKMMI_TEST_PROCID);
}
...
{
	return tlktsk_adapt_interval(TLKMMI_TEST_PROCID);
}
...
{
	return tlktsk_adapt_initTimer(TLKMMI_TEST_PROCID, pTimer, timerCB, userArg, timeout);
}
int tlkmmi_test_adaptInitQueue(tlkapi_queue_t *pProcs, TlkApiQueueCB queueCB, uint32 userArg)
{
	return tlktsk_adapt_initQueue(TLKMMI_TEST_PROCID, pProcs, queueCB, userArg);
}
void tlkmmi_test_adaptDeinitTimer(tlkapi_timer_t *pTimer)
{
	tlktsk_adapt_deinitTimer(TLKMMI_TEST_PROCID, pTimer);
}
void tlkmmi_test_adaptDeinitQueue(tlkapi_queue_t *pProcs)
{
	tlktsk_adapt_deinitQueue(TLKMMI_TEST_PROCID, pProcs);
}
...
{
	return tlktsk_adapt_isHaveTimer(TLKMMI_TEST_PROCID, pTimer);
}
bool tlkmmi_test_adaptIsHaveQueue(tlkapi_queue_t *pProcs)
{
	return tlktsk_adapt_isHaveQueue(TLKMMI_TEST_PROCID, pProcs);
}
...
{	
	return tlktsk_adapt_appendQueue(TLKMMI_TEST_PROCID, pProcs);
}
int tlkmmi_test_adaptRemoveQueue(tlkapi_queue_t *pProcs)
{
	return tlktsk_adapt_removeQueue(TLKMMI_TEST_PROCID, pProcs);
}
...
{
	return tlktsk_adapt_updateTimer(TLKMMI_TEST_PROCID, pTimer, timeout, isInsert);
}
int tlkmmi_test_adaptInsertTimer(tlkapi_timer_t *pTimer)
{
	return tlktsk_adapt_insertTimer(TLKMMI_TEST_PROCID, pTimer, true);
}
int tlkmmi_test_adaptRemoveTimer(tlkapi_timer_t *pTimer)
{
	return tlktsk_adapt_removeTimer(TLKMMI_TEST_PROCID, pTimer);
}
