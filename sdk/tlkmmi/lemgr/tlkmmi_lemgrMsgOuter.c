...
int tlkmmi_lemgr_outerMsgHandler(uint08 msgID, uint08 *pData, uint08 dataLen)
{
...
static void tlkmmi_lemgr_recvConnectCmdDeal(uint08 *pData, uint08 dataLen)
{
	tlkmmi_lemgr_sendCommRsp(TLKPRT_COMM_CMDID_LE_CONNECT, TLKPRT_COMM_RSP_STATUE_FAILURE, TLK_ENOSUPPORT, nullptr, 0);
}
static void tlkmmi_lemgr_recvDisconnCmdDeal(uint08 *pData, uint08 dataLen)
{
...
static void tlkmmi_lemgr_recvStartAdvCmdDeal(uint08 *pData, uint08 dataLen)
{
	...
	if(tlkmmi_lemgr_startAdv(timeout, pData[2]) != TLK_ENONE){
		tlkmmi_lemgr_sendCommRsp(TLKPRT_COMM_CMDID_LE_START_ADV, TLKPRT_COMM_RSP_STATUE_FAILURE, TLK_EFAIL, nullptr, 0);
	}else{
...
static void tlkmmi_lemgr_recvCloseScanCmdDeal(uint08 *pData, uint08 dataLen)
{
	tlkmmi_lemgr_sendCommRsp(TLKPRT_COMM_CMDID_LE_CLOSE_SCAN, TLKPRT_COMM_RSP_STATUE_FAILURE, TLK_ENOSUPPORT, nullptr, 0);
}
static void tlkmmi_lemgr_recvGetNameCmdDeal(void)
{
	uint08 buffLen;
