...
#define TLKMMI_BTMGR_MAJOR_SERVICE_CALSS	(BTH_COD_SERVICE_CLASS_AUDIO | BTH_COD_SERVICE_CLASS_RENDER)
#define TLKMMI_BTMGR_MAJOR_DEVICE_CALSS		(BTH_COD_MAJOR_CLASS_AUDIO)
#define TLKMMI_BTMGR_MINOR_DEVICE_CALSS		(BTH_COD_AUDIO_WEARABLE_HEADSET)

#define TLKMMI_BTMGR_DEVICE_CLASS     (TLKMMI_BTMGR_MAJOR_SERVICE_CALSS | TLKMMI_BTMGR_MAJOR_DEVICE_CALSS | TLKMMI_BTMGR_MINOR_DEVICE_CALSS)//0x240404//0x5a020c
