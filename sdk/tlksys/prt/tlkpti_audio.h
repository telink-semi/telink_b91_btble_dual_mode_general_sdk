...
/********************************************************************************************************
 * MsgType[word<15>] + TskType[word<14~11>] + MsgLen[word<10~0>] + MsgID[word]
 *******************************************************************************************************/
#define TLKPTI_AUD_MSG_TYPE        0x01  //Fixed:Inner Message
#define TLKPTI_AUD_TSK_TYPE        0x01  //Fixed:Audio Task
#define TLKPTI_AUD_TYPE            ((TLKPTI_AUD_MSG_TYPE << 15) | (TLKPTI_AUD_TSK_TYPE << 11))

enum TLKPTI_AUD_MSGID_ENUM{
