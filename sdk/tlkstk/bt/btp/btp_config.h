...
#define TLKBTP_CFG_IAP_DBG_ENABLE        (1 && TLKBTP_CFG_DBG_ENABLE && TLKBTP_CFG_IAP_ENABLE)
#define TLKBTP_CFG_SPP_DBG_ENABLE        (1 && TLKBTP_CFG_DBG_ENABLE && TLKBTP_CFG_SPP_ENABLE)
...
#define TLKBTP_CFG_HID_DBG_ENABLE        (1 && TLKBTP_CFG_DBG_ENABLE && TLKBTP_CFG_HID_ENABLE)
#define TLKBTP_CFG_HIDD_DBG_ENABLE       (1 && TLKBTP_CFG_DBG_ENABLE && TLKBTP_CFG_HIDD_ENABLE)
#define TLKBTP_CFG_HIDH_DBG_ENABLE       (1 && TLKBTP_CFG_DBG_ENABLE && TLKBTP_CFG_HIDH_ENABLE)
