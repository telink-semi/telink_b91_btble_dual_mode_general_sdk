...
#define TLK_BT_HIDP_MAX_NUMB               (TLK_STK_BTACl_NUMB)
...
#define TLKBTP_CFG_HID_ENABLE            (0 && TLK_STK_BTP_ENABLE)
...
#define TLKBTP_CFG_HIDDEVICE_DBG_ENABLE  (0 && TLKBTP_CFG_DBG_ENABLE && TLKBTP_CFG_HID_ENABLE)
