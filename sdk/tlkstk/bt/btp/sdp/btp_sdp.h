...
#define BTP_SDP_SRVCLASS_ID_LAN_ACCES				0x1102
...
*******************************************************************************/
int  btp_sdp_init(void);

/******************************************************************************
 * Function: SDP Deinit interface
 * Descript: This interface be used by User to de-initial sdp resource
 * Params:
 * Return:
*******************************************************************************/
void btp_sdp_deinit(void);
