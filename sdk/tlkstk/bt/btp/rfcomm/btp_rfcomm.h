...
#define BTP_RFCOMM_SESSION_TIMEOUT           100000 //100ms
#define BTP_RFCOMM_CHANNEL_TIMEOUT           100000 //100ms
#define BTP_RFCOMM_SESSION_2S                (2000000/BTP_RFCOMM_SESSION_TIMEOUT) 


#define BTP_RFCOMM_SESSION_CONN_TIMEOUT      (6000000/BTP_RFCOMM_SESSION_TIMEOUT)
#define BTP_RFCOMM_SESSION_DISC_TIMEOUT      (6000000/BTP_RFCOMM_SESSION_TIMEOUT)

#define BTP_RFCOMM_CHANNEL_CONN_TIMEOUT      (5000000/BTP_RFCOMM_CHANNEL_TIMEOUT)
#define BTP_RFCOMM_CHANNEL_DISC_TIMEOUT      (4000000/BTP_RFCOMM_CHANNEL_TIMEOUT)
...
#define RFCOMM_SKB_HEAD_RESERVE	4
...
typedef struct{
	btp_rfcomm_service_t service[TLK_BT_RFCOMM_SERVICE_MAX_NUMB]; //16*4
	btp_rfcomm_session_t session[TLK_BT_RFCOMM_SESSION_MAX_NUMB]; //32*2
	btp_rfcomm_channel_t channel[TLK_BT_RFCOMM_CHANNEL_MAX_NUMB]; //44*6
	btp_rfcomm_chndict_t chndict[TLK_BT_RFCOMM_CHNDICT_MAX_NUMB]; //4*10
}btp_rfcomm_ctrl_t;
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int  btp_rfcomm_appendService(uint08 serviceID, BtpRfcommEventCB eventCB, BtpRfcommRdataCB rdataCB, BtpRfcommFlowIndCB flowIndCB);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_rfcomm_extendSend(uint08 rfcomm_handle, uint08 *pHead, uint16 headLen, uint08 *pBody, uint32 bodyLen, bool isFinal);
