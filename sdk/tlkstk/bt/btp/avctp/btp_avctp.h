...
*******************************************************************************/
int btp_avrcp_sendCmd(uint16 aclHandle, uint16 scid, uint08 trid, uint16 pid, uint08 *pHead, uint08 headLen, uint08 *pData, uint08 dataLen);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avrcp_sendRsp(uint16 aclHandle, uint16 scid, uint08 trid, uint16 pid, uint08 *pHead, uint08 headLen, uint08 *pData, uint08 dataLen);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avrcp_sendErr(uint16 aclHandle, uint16 scid, uint08 trid, uint16 pid, uint08 *pHead, uint08 headLen, uint08 *pData, uint08 dataLen);
