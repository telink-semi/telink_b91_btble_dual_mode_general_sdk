...
static int btp_func_a2dpSrcSendMediaData(uint08 *pData, uint16 dataLen)
{
	...
	uint08 SBCBuffer[] = {
							};
	if(pData == nullptr || dataLen < 2){
...
static int btp_func_a2dpSrcSendMediaData01(uint08 *pData, uint16 dataLen)
{
	...
	uint08 SBCBuffer[] = {
					   	   };
	if(pData == nullptr || dataLen < 2){
...
static int btp_func_a2dpSrcSendMediaData02(uint08 *pData, uint16 dataLen)
{
	...
	uint08 SBCBuffer[] = {
					   	   0x0f,0x9c,0xf2,0x12,0x9A, 0x00, 0x00, 0x7b,0xdd,0xde,0xf7,0x77,0xbd,0xdd,0xef,0x77,0x7b,0xdd,0xde,0xf7,0x77,
						   0xbd,0xdd,0xef,0x77,0x7b,0xdd,0xde,0xf7,0x77,0xbd,0xdd,0xef,0x77,0x7b,0xdd,0xde,0xf7,0x77,0xbd,0xdd,0xef,0x77,
						   0x9c,0xf2,0x12,0x9A, 0x00, 0x00, 0x7b,0xdd,0xde,0xf7,0x77,0xbd,0xdd,0xef,0x77,0x7b,0xdd,0xde,0xf7,0x77,
						   0xbd,0xdd,0xef,0x77,0x7b,0xdd,0xde,0xf7,0x77,0xbd,0xdd,0xef,0x77,0x7b,0xdd,0xde,0xf7,0x77,0xbd,0xdd,0xef,0x77,
						   0x9c,0xf2,0x12,0x17,0x31,0x00,0x7e,0xf6,0xdf,0xbd,0xb7,0xef,0x6d,0xfb,0xdb,0x7e,0xf6,0xdf,0xbd,0xb7,0xef,0x6d,
						   0xfb,0xdb,0x78,0xe6,0xdd,0xc5,0x34,0x87,0x75,0x02,0xe3,0x79,0x35,0x99,0xf6,0x5a,0xe5,0x47,0x61,0xa3
						  };
	if(pData == nullptr || dataLen < 2){
		tlkapi_error(BTP_FUNC_DBG_FLAG, BTP_FUNC_DBG_SIGN, "btp_func_a2dpSrcSendMediaData: failure - param error");
		return -TLK_EPARAM;
...
static int btp_func_a2dpSrcSendMediaData03(uint08 *pData, uint16 dataLen)
{
	...
	uint08 SBCBuffer[] = {
							0x0f,0x9c,0x91,0x20,0x34,0xc9,0x54,0x23,0x22,0x63,0x5b,0x97,0xb5,0x5b,0xe0,0x76,0x71,
							0xb5,0xaf,0x48,0x4d,0xc4,0x0c,0x14,0x6e,0x4d,0x60,0x79,0x8d,0x07,0xaa,0x73,0x4c,0xa9,
							0x55,0x1a,0x51,0xc3,0x51,0xc5,0xa9,0x9c,0x91,0x20,0xf2,0xc9,0x53,0x22,0x22,0x71,0x1e,
							0x2a,0x8a,0x70,0x2f,0x0e,0x71,0x8e,0x06,0xba,0x74,0xa4,0x32,0x52,0x24,0x3c,0x8a,0xc1,
							0x6d,0x46,0x33,0xa3,0x20,0x9e,0xb4,0x30,0x95,0x82,0xa1,0x03,0xb1
						  };
	if(pData == nullptr || dataLen < 2){
...
static int btp_func_a2dpSrcSetCapacityParam(uint08 *pData, uint16 dataLen)
{
	...
	chnMode = pData[0];
	if(chnMode == 0) chnMode = 0x01;
	frequency = pData[1];
	if(frequency == 0) frequency = 0x01 | 0x02 | 0x04 | 0x08;
	allocaMethod = pData[2];
	if(allocaMethod == 0) allocaMethod = 0x01;
	subbands = pData[3];
	if(subbands == 0) subbands = 0x01;
	blockLength = pData[4];
	if(blockLength == 0) blockLength = 0x01;
	minBitpool = pData[5];
	if(minBitpool == 0) minBitpool = 2;
	maxBitpool = pData[6];
	if(maxBitpool == 0) maxBitpool = 36;
	tlkapi_trace(BTP_FUNC_DBG_FLAG, BTP_FUNC_DBG_SIGN, "btp_func_a2dpSrcSetCapacityParam: chnMode[0x%x] freq[0x%x] method[0x%x] "
										"subbands[0x%x] blockLen [0x%x] minBitpool[0x%x] maxBitpool[0x%x]",
										chnMode, frequency, allocaMethod, subbands, blockLength, minBitpool, maxBitpool);
	return btp_a2dpsrc_setCodecCapacity(chnMode, frequency, allocaMethod, subbands, blockLength, minBitpool, maxBitpool);
}
