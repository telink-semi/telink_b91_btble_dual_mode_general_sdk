...
*******************************************************************************/
int btp_avdtp_sendMedia(uint16 aclHandle, uint16 scid, uint16 seqNumber, uint32 timestamp, uint32 srcDataID, uint08 *pPayload, uint16 payloadSize);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendPacket(uint16 aclHandle, uint16 scid, uint08 msgType, uint08 label, uint08 sigID, uint08 *pData, uint16 dataLen);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendStartPacket(uint16 aclHandle, uint16 scid, uint08 msgType, uint08 label, uint08 nosp, uint08 sigID, uint08 *pData, uint16 dataLen);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendContinuePacket(uint16 aclHandle, uint16 scid, uint08 msgType, uint08 label, uint08 *pData, uint16 dataLen);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendSetConfigCmd(uint16 aclHandle, uint16 scid, uint08 label, uint08 acpSeid, uint08 intSeid, uint08 *pData, uint16 dataLen);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendSetConfigRej(uint16 aclHandle, uint16 scid, uint08 label, uint08 errID);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendReconfigCmd(uint16 aclHandle, uint16 scid, uint08 label, uint08 acpSeid, uint08 *pData, uint16 dataLen);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendStartRej(uint16 aclHandle, uint16 scid, uint08 label, uint08 errID);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
int btp_avdtp_sendSecControlCmd(uint16 aclHandle, uint16 scid, uint08 label, uint08 acpSeid, uint08 *pData, uint16 dataLen);
