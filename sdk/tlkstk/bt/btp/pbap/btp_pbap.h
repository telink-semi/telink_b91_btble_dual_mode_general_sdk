...
typedef void (*BtpPbapcBookCallback)(uint16 aclHandle, uint08 endFlag, bool isSucc, btp_pbap_info_t *pInfo, uint08 itemCount);
 ...
 *         If others value is returned means the send process fail.
*******************************************************************************/
extern int btp_pbapclt_startSyncBook(uint16 aclHandle, int bookPosi, int bookType, int bookSort, uint16 offset, uint16 count);
