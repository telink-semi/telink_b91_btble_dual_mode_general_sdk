 ...
 * Params:
 * Reutrn: Returning TLK_ENONE(0x00) means the send process success.
 ...
 *           others device.
 * Params: @aclhandle[IN]--The acl link handle.
 * Reutrn: Return true means peer device type headset, false means others .
*******************************************************************************/
 ...
 * Reutrn: TLK_ENONE is set sucess, others means failure.
*******************************************************************************/
extern int  bth_acl_connect(uint08 btaddr[6], uint32 devClass, uint08 initRole, uint16 timeout);
